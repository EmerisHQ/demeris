<template>
  ...
  >
    ...
    <div class="staking-banner__circles z-50 absolute right-0 top-0">
      <CircleSymbol :denom="baseDenom" custom-size="50" />
      <CircleSymbol :denom="baseDenom" custom-size="26" />
      <CircleSymbol :denom="baseDenom" custom-size="16" />
    </div>
  </router-link>
</template>
<script lang="ts">
