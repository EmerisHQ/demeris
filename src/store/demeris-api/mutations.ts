...
export type Mutations<S = State> = {
  ...
  [MutationTypes.SET_STAKING_BALANCES](state: S, payload: { params: API.APIRequests; value: API.StakingBalances }): void
  ...
  [MutationTypes.SET_PRIMARY_CHANNELS](state: S, payload: { params: API.APIRequests; value: API.PrimaryChannels }): void
  [MutationTypes.SET_TOKEN_PRICES](state: S, payload: { params: API.APIRequests; value: any[] }): void
  [MutationTypes.SET_TOKEN_PRICES_STATUS](state: S, payload: { params: API.APIRequests; value: API.LoadingState }): void
