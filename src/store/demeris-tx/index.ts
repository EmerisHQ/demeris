...
export type TXStore<S = TXState> = Omit<VuexStore<S>, 'getters' | 'commit' | 'dispatch'> & {
...
export type NamespacedTXStore<S = TXState> = Omit<TXStore<S>, 'getters' | 'dispatch'> & {
...
export const module: Module<TXState, RootState> = {
