...
test.beforeEach(async ({ page }) => {
  ...
  await page.goto('/asset/uatom?VITE_FEATURE_TRANSACTIONS_CENTER=true'); // TODO: Our redirects flicker the original URL before going to welcome which confuses the tests. Needs fixing on the router level
